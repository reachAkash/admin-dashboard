...
import Logo from "../assets/logo/mpLogo.svg";
...
const Sidebar = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 font-montserrat top-0 z-9999 flex h-screen w-72.5 text-base leading-7 flex-col overflow-y-hidden bg-primary duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 ${
    ...
    >
      ...
      <div className="flex items-center justify-center gap-2 px-6 py-5.5 lg:py-6.5">
        <Link
          to="/"
          className="text-white gap-4 flex items-center w-full justify-start font-semibold text-2xl"
        >
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              <React.Fragment>
                <NavLink
                  to="#"
                  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-white hover:text-primary duration-300 ease-in-out hover:bg-white dark:hover:bg-meta-4 ${
              ...
              <li>
                <NavLink
                  to="/calendar"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-white hover:text-primary duration-300 ease-in-out hover:bg-white dark:hover:bg-meta-4 ${
